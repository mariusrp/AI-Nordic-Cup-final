"""lin_tune = lineage6 with young_gap 40 -> 30 and spawn_bar_late 230 -> 200 (surv2 lin_tune sweep, 19 Sep 23:00).
Frozen scorer, paired vs lineage6: seeds 5000-5015 (selection) +87.0 se 68.1; 5016-5031 +58.5 se 60.9; fresh 6000-6031 +15.7 se 58.4;
pooled 64 seeds +44.3 se 36.8 (z 1.2, 32/64 wins). MARGINAL, not significant: the 12-arm one-at-a-time sweep (herd_div 5/7, tree_half
500/620, lottery_t 450/750, spawn_bar_late 200/260, pre_age 50/65, young_gap 20/30/55) is flat within the null band except pre_age 65
(-105). LIN_PARAMS='{"young_gap": 40.0, "spawn_bar_late": 230.0}' restores lineage6 exactly.
...
LIN = dict(
    ...
    birth_gap=6.0, young_gap=30.0, spawn_bar=170.0, spawn_bar_late=200.0, fast_bar=150.0, res0=60.0, res_slope=0.02, lock_margin=10.0,
